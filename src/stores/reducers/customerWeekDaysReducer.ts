...
const customerWeekDaysReducer = (
  ...
  switch (action.type) {
    ...
    case CustomerWeekDaysActionTypes.PUT_CUSTOMER_WEEK_DAYS_REQUEST:
      return {
        ...state,
        customerWeekDay: null,
        error: null,
      };
    case CustomerWeekDaysActionTypes.PUT_CUSTOMER_WEEK_DAYS_SUCCESS:
      return {
        ...state,
        customerWeekDay: action.payload,
        error: null,
      };
    case CustomerWeekDaysActionTypes.PUT_CUSTOMER_WEEK_DAYS_FAILURE:
      return {
        ...state,
        customerWeekDay: null,
        error: action.payload,
      };
    case CustomerWeekDaysActionTypes.DELETE_CUSTOMER_WEEK_DAYS_REQUEST:
      return {
        ...state,
        error: null,
      };
    case CustomerWeekDaysActionTypes.DELETE_CUSTOMER_WEEK_DAYS_SUCCESS:
      return {
        ...state,
        error: null,
      };
    case CustomerWeekDaysActionTypes.DELETE_CUSTOMER_WEEK_DAYS_FAILURE:
      return {
        ...state,
        error: action.payload,
      };
